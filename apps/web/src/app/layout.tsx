...
export default function RootLayout({ children }: { children: React.ReactNode }) { return <html lang="es"><body><StoreProvider><a href="#main-content" className="skip-link">Ir al contenido</a><Header /><main id="main-content">{children}</main><Footer /></StoreProvider></body></html>; }
